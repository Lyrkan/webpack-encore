...
module.exports = function(plugins, webpackConfig) {
    ...
    // Also push our own EntryFilesManifestPlugin that will change
    // the content of the generated entrypoints.json file. The order
    // here is important since its afterEmit has to be called
    // after the one from the AssetsPlugin
    plugins.push({
