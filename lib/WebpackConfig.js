...
/** @typedef {import("webpack").ExternalsElement} ExternalsElement */

/** @typedef {import("./config/RuntimeConfig")} RuntimeConfig */
/** @typedef {import("../declarations/WebpackConfig").ConfiguredFilenames} ConfiguredFilenames */
/** @typedef {import("../declarations/WebpackConfig").CopyFilesConfig} CopyFilesConfig */
/** @typedef {import("../declarations/WebpackConfig").BabelOptions} BabelOptions */
/** @typedef {import("../declarations/WebpackConfig").PreactOptions} PreactOptions */
/** @typedef {import("../declarations/WebpackConfig").SassOptions} SassOptions */
/** @typedef {import("../declarations/WebpackConfig").UrlLoaderOptions} UrlLoaderOptions */
...
class WebpackConfig {
    ...
    constructor(runtimeConfig) {
        ...
        /** @type {{plugin: Plugin, priority: number}[]} */
        this.plugins = [];
        /** @type {Rule[]} */
        this.loaders = [];
